      ...
      >
        ...
        >
          ...
          <div className="space-y-4 mt-8 text-lg">
            <motion.div 
              variants={itemFromLeft}
              className="flex items-center gap-4 hover:bg-gradient-to-r hover:from-indigo-500 hover:to-purple-600 hover:bg-clip-text hover:text-transparent transition-all duration-300"
            >
              <IoLocationOutline className="mr-1" size={25}/>
            ...
            <motion.div 
              ...
              className="flex items-center gap-4 hover:bg-gradient-to-r hover:from-indigo-500 hover:to-purple-600 hover:bg-clip-text hover:text-transparent transition-all duration-300"
            >
              <MdOutlineEmail className="mr-1" size={25}/>
            ...
            <motion.div 
              ...
              className="flex items-center gap-4 hover:bg-gradient-to-r hover:from-indigo-500 hover:to-purple-600 hover:bg-clip-text hover:text-transparent transition-all duration-300"
            >
              <FaPhone className="mr-1" size={25}/>
          ...
          >
            <p className="font-semibold text-gray-300">Follow Me</p>
            <div className="flex gap-4 pt-2">
              <motion.a
                href="https://x.com/kwamboka_012?t=4D3jgTfG4Fhf_yHKurgQZw&s=09"
                target="_blank"
                rel="noopener noreferrer"
                className="hover:bg-gradient-to-r hover:from-indigo-500 hover:to-purple-600 hover:bg-clip-text hover:text-transparent transition-all duration-300 flex items-center p-2 gap-3 text-gray-400 text-xl"
                aria-label="Twitter"
        ...
        >
          <form className="bg-gray-900 p-8 rounded-xl space-y-6 shadow-md w-full border border-gray-800">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
              <motion.div variants={itemFromRight}>
                <label className="block mb-1 font-medium text-gray-300">Full Name *</label>
                <input
                  type="text"
                  className="w-full p-3 rounded bg-gray-800 text-white border border-gray-700 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent"
                  required
                />
              </motion.div>
              <motion.div variants={itemFromRight}>
            ...
            >
              <button
                type="submit"
                className="bg-gradient-to-r from-indigo-500 to-purple-600 hover:from-indigo-600 hover:to-purple-700 text-white font-semibold py-3 px-6 rounded transition-all duration-300 w-full shadow-lg hover:shadow-xl"
              >
                Send Me a Message →
              </button>
            </motion.div>
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-6">
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:from-indigo-500 transition-all duration-300"
                aria-label="Twitter"
                whileHover={{ scale: 1.1 }}
              >
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:to-purple-600 transition-all duration-300"
                aria-label="GitHub"
                whileHover={{ scale: 1.1 }}
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-gra hover:to-purple-600 transition-all duration-300"
                aria-label="LinkedIn"
                whileHover={{ scale: 1.1 }}
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
