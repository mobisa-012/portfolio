          ...
          >
            ...
            <div className="flex gap-3 sm:gap-4 pt-2">
              <motion.a
                ...
                className="hover:bg-gradient-to-r hover:from-indigo-500 hover:to-purple-600 hover:bg-clip-text hover:text-transparent transition-all duration-300 flex items-center p-1 sm:p-2 gap-2 sm:gap-3 text-gray-400 text-lg sm:text-xl"
                aria-label="Twitter"
          ...
          <div className="flex flex-col md:flex-row justify-between items-center gap-2 sm:gap-4">
            ...
            <div className="flex gap-3 sm:gap-4 md:gap-6">
              ...
              <motion.a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="text-gray-400 hover:bg-gradient-to-r hover:from-indigo-500 hover:to-purple-600 hover:bg-clip-text hover:text-transparent transition-all duration-300"
                aria-label="Twitter"
                whileHover={{ scale: 1.1 }}
              >
